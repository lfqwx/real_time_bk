...
import com.cy.util.HttpUtil;
import com.cy.util.ToolUtil;
...
public class Portal {
	...
	public static HashMap<String, String> Get_Lt_Execution(HttpUtil httpUtil) {
		try {
			...
			String lt = doc.select("//*[@id='login-from']/div[6]/input[1]/@value").first().toString();
			String execution = doc.select("//*[@id='login-from']/div[6]/input[2]/@value").first().toString();
